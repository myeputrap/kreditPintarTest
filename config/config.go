...
type GRPC struct {
	DPTService      HostPort      `yaml:"dpt_service"`
	Init            int           `yaml:"init"`
...
// RateLimit is rate limit config
type RateLimit struct {
	LimiterMax               int64 `yaml:"limiter_max"`
	LimiterExpiration        int64 `yaml:"limiter_expiration"`
	LimiterMaxOpenAPI        int64 `yaml:"limiter_max_open_api"`
	LimiterExpirationOpenAPI int64 `yaml:"limiter_expiration_open_api"`
}
...
var defaultConfig = &Config{
	...
	RateLimit: RateLimit{
		LimiterMax:               10,
		LimiterExpiration:        60,
		LimiterMaxOpenAPI:        10,
		LimiterExpirationOpenAPI: 60,
	},
